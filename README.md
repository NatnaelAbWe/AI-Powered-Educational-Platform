# SkillPath – AI-Powered Tech Skills Learning Platform
...
- In Scope:
  ...
  - Roadmap-based course interface (step-by-step progression)
  - Course enrollment and lesson access
  - Progress tracking per course
  - AI-powered learning assistance (code help, explanations, exercises)
  - Real-time chat system (student–teacher)
  - Payment integration (test mode using Chapa)
...
- Students learning programming or tech skills
- Beginners in web development or software engineering
...
- SkillPath provides a structured alternative to scattered online tutorials by guiding users through clear learning paths while offering AI assistance for coding and understanding concepts.

#### Product Features

- Roadmap-based learning interface
- AI code assistant and explanation tools
- Course enrollment and structured lessons
- Real-time communication system
- Payment system for premium courses

#### User Classes

- Students: Enroll in courses, complete lessons, use AI tools
- Teachers: Create and manage courses and lessons
...
#### Course & Roadmap System

- Users can view available courses
- Courses displayed as roadmap (NOT cards)
- Lessons are:
  - Locked
  - Unlocked
  - Completed
...
- AI Code Helper
- Fix user-submitted code
- Provide explanations
- AI Explanation Tool
- Explain programming concepts simply
- AI Practice Generator
- Generate exercises based on lesson topics
- AI Answer Feedback
- Evaluate user answers and provide corrections
